...
<template>
  <div>
    ...
    <!-- 分配角色的对话框 -->
    <el-dialog title="分配角色" :visible.sync="assRoleDiaVisible" width="50%" @close="setRoleDiaClo">
      <div>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button @click="assRoleDiaVisible = false">取 消</el-button>
